...
public class TBMSessionLogonEventDaoImplTest {
	
	@Autowired
	private  JmsServiceInterface<TBMRequest, ?> tbmSessionLogonEventDaoImpl; // NOPMD
	...
	public void sendMessageSuccess() {
		try {
			...
			request.setCustomerId("customerID1234");
			tbmSessionLogonEventDaoImpl.sendMessage(request);
