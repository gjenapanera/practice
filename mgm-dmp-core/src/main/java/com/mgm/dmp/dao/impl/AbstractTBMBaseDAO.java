 ...
 *
 */
public abstract class AbstractTBMBaseDAO<I, O> extends AbstractBaseJmsService<I, O> {
	 
	protected static final Logger LOG = LoggerFactory.getLogger(AbstractTBMBaseDAO.class.getName());
